.class public final Lcom/nextpeer/android/facebook/internal/NativeProtocol;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/nextpeer/android/facebook/internal/NativeProtocol;->PLATFORM_PROVIDER_VERSIONS_URI:Landroid/net/Uri;
    ...
    sput-object v0, Lcom/nextpeer/android/facebook/internal/NativeProtocol;->KNOWN_PROTOCOL_VERSIONS:Ljava/util/List;
...
.method public static createLoginDialog20121101Intent(Landroid/content/Context;Ljava/lang/String;Ljava/util/ArrayList;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p2}, Lcom/nextpeer/android/facebook/internal/NativeProtocol;->ensureDefaultPermissions(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {}, Lcom/nextpeer/android/facebook/internal/NativeProtocol;->generateCallId()Ljava/lang/String;
    ...
    invoke-static {p3}, Lcom/nextpeer/android/facebook/internal/NativeProtocol;->ensureDefaultAudience(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lcom/nextpeer/android/facebook/internal/NativeProtocol;->validateKatanaActivityIntent(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/Intent;
...
.method public static createPlatformServiceIntent(Landroid/content/Context;)Landroid/content/Intent;
    ...
    invoke-static {p0, v0}, Lcom/nextpeer/android/facebook/internal/NativeProtocol;->validateKatanaServiceIntent(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/Intent;
...
.method public static createProxyAuthIntent(Landroid/content/Context;Ljava/lang/String;Ljava/util/List;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p2}, Lcom/nextpeer/android/facebook/internal/Utility;->isNullOrEmpty(Ljava/util/Collection;)Z
    ...
    :cond_0
    invoke-static {p3}, Lcom/nextpeer/android/facebook/internal/Utility;->isNullOrEmpty(Ljava/lang/String;)Z
...
.method private static ensureDefaultAudience(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/nextpeer/android/facebook/internal/Utility;->isNullOrEmpty(Ljava/lang/String;)Z
...
.method private static ensureDefaultPermissions(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-static {p0}, Lcom/nextpeer/android/facebook/internal/Utility;->isNullOrEmpty(Ljava/util/Collection;)Z
...
.method public static getErrorFromResult(Landroid/content/Intent;)Ljava/lang/Exception;
    ...
    invoke-static {p0}, Lcom/nextpeer/android/facebook/internal/NativeProtocol;->isErrorResult(Landroid/content/Intent;)Z
    ...
    invoke-direct {v0, v1}, Lcom/nextpeer/android/facebook/FacebookOperationCanceledException;-><init>(Ljava/lang/String;)V
...
.method public static getLatestAvailableProtocolVersion(Landroid/content/Context;I)I
    ...
    sget-object v1, Lcom/nextpeer/android/facebook/internal/NativeProtocol;->PLATFORM_PROVIDER_VERSIONS_URI:Landroid/net/Uri;
    ...
    sget-object v0, Lcom/nextpeer/android/facebook/internal/NativeProtocol;->KNOWN_PROTOCOL_VERSIONS:Ljava/util/List;
...
.method static validateKatanaActivityIntent(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/Intent;
    ...
    invoke-static {p0, v1}, Lcom/nextpeer/android/facebook/internal/NativeProtocol;->validateSignature(Landroid/content/Context;Ljava/lang/String;)Z
