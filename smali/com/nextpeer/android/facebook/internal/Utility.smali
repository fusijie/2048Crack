.class public final Lcom/nextpeer/android/facebook/internal/Utility;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/nextpeer/android/facebook/internal/Utility$FetchedAppSettings;
    }
.end annotation
...
.field private static final TAG_COOKIES_DISCARD:Ljava/lang/String; = "Discard"

.field private static final TAG_COOKIES_DOMAIN:Ljava/lang/String; = "Domain"

.field private static final TAG_COOKIES_EXPIRES:Ljava/lang/String; = "Expires"

.field private static final TAG_COOKIES_NAME:Ljava/lang/String; = "Name"

.field private static final TAG_COOKIES_PATH:Ljava/lang/String; = "Path"

.field private static final TAG_COOKIES_VALUE:Ljava/lang/String; = "Value"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/nextpeer/android/facebook/internal/Utility;->APP_SETTING_FIELDS:[Ljava/lang/String;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    sput-object v0, Lcom/nextpeer/android/facebook/internal/Utility;->fetchedAppSettings:Ljava/util/Map;
...
.method public static clearFacebookCookies(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0}, Lcom/nextpeer/android/facebook/internal/Utility;->clearCookiesForDomain(Landroid/content/Context;Ljava/lang/String;)V
...
.method static convertJSONObjectToHashMap(Lorg/json/JSONObject;)Ljava/util/Map;
    ...
    invoke-static {v0}, Lcom/nextpeer/android/facebook/internal/Utility;->convertJSONObjectToHashMap(Lorg/json/JSONObject;)Ljava/util/Map;
...
.method public static deleteDirectory(Ljava/io/File;)V
    ...
    invoke-static {v3}, Lcom/nextpeer/android/facebook/internal/Utility;->deleteDirectory(Ljava/io/File;)V
...
.method private static getCookieValue(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static getFacebookCookies(Landroid/content/Context;Ljava/lang/String;)Ljava/util/ArrayList;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v5, v9, v0, p1}, Lcom/nextpeer/android/facebook/internal/Utility;->getCookieValue(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/util/Map;
...
.method public static getMetadataApplicationId(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v0, "192019987525706"
...
.method public static final isFacebookSupportedOnDevice(Landroid/content/Context;)Z
    .locals 6
...
.method public static queryAppSettings(Ljava/lang/String;Z)Lcom/nextpeer/android/facebook/internal/Utility$FetchedAppSettings;
    .locals 5
    ...
    sget-object v0, Lcom/nextpeer/android/facebook/internal/Utility;->fetchedAppSettings:Ljava/util/Map;
    ...
    check-cast v0, Lcom/nextpeer/android/facebook/internal/Utility$FetchedAppSettings;
    ...
    sget-object v3, Lcom/nextpeer/android/facebook/internal/Utility;->APP_SETTING_FIELDS:[Ljava/lang/String;
    ...
    invoke-static {v4, p0, v4}, Lcom/nextpeer/android/facebook/Request;->newGraphPathRequest(Lcom/nextpeer/android/facebook/Session;Ljava/lang/String;Lcom/nextpeer/android/facebook/Request$Callback;)Lcom/nextpeer/android/facebook/Request;

    move-result-object v1

    invoke-virtual {v1, v0}, Lcom/nextpeer/android/facebook/Request;->setParameters(Landroid/os/Bundle;)V
    ...
    new-instance v0, Lcom/nextpeer/android/facebook/internal/Utility$FetchedAppSettings;

    const-string v2, "supports_attribution"

    invoke-static {v1, v2}, Lcom/nextpeer/android/facebook/internal/Utility;->safeGetBooleanFromResponse(Lcom/nextpeer/android/facebook/model/GraphObject;Ljava/lang/String;)Z

    move-result v2

    const-string v3, "supports_implicit_sdk_logging"

    invoke-static {v1, v3}, Lcom/nextpeer/android/facebook/internal/Utility;->safeGetBooleanFromResponse(Lcom/nextpeer/android/facebook/model/GraphObject;Ljava/lang/String;)Z

    move-result v1

    invoke-direct {v0, v2, v1, v4}, Lcom/nextpeer/android/facebook/internal/Utility$FetchedAppSettings;-><init>(ZZLcom/nextpeer/android/facebook/internal/Utility$FetchedAppSettings;)V

    sget-object v1, Lcom/nextpeer/android/facebook/internal/Utility;->fetchedAppSettings:Ljava/util/Map;
...
.method private static safeGetBooleanFromResponse(Lcom/nextpeer/android/facebook/model/GraphObject;Ljava/lang/String;)Z
    .locals 3
    ...
    invoke-interface {p0, p1}, Lcom/nextpeer/android/facebook/model/GraphObject;->getProperty(Ljava/lang/String;)Ljava/lang/Object;
